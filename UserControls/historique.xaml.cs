...
namespace projet23_Station_météo_WPF.UserControls
{
    ...
    public partial class historique : System.Windows.Controls.UserControl
    {
        ...
        public void refreshUi()
        {
            ...
            controlDirectionVent.graph.setInfo("direction du vent", (string)App.Current.Properties["unitDvent"], "images/icons/DirectionVent.png");
            controlPressionAtmospherique.graph.setInfo("pression atmosphérique", (string)App.Current.Properties["unitPresAtmo"], "images/icons/pression.png");
        ...
        void editFormaDate(string date)
        {
            ...
            controlHygro.graph.date = date;
            controlVitesseVent.graph.date = date;
            controlDirectionVent.graph.date = date;
            controlPressionAtmospherique.graph.date = date;
        ...
        void dataSearch(string startDate, string endDate, int index)
        {
            ...
            if (index == 0)
            {
                ...
                {
                    DialogResult result = System.Windows.Forms.MessageBox.Show("Vous sélectionnez beaucoup de données(" + jsonData.Count + "), il peut il y avoir de forts ralentissments.\nÉtês-vous sûr de vouloir continuer?", "ATTENTION", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
            ...
            Dictionary<string, List<dynamic>> listV = new Dictionary<string, List<dynamic>>()
            {
                ...
                {"Pluviometre", new List<dynamic>() { controlPluviometrie }},
